...
public func error(message: String, error: Error, details: [String: Any]?) {
    JournalProvider.shared.journal.log(message: message, level: .error, details: details ?? [:], error: error)
}

public func warning(message: String, details: [String: Any]?) {
    JournalProvider.shared.journal.log(message: message, level: .warning, details: details ?? [:], error: nil)
}

public func info(message: String, details: [String: Any]?) {
    JournalProvider.shared.journal.log(message: message, level: .warning, details: details ?? [:], error: nil)
}

public func debug(message: String, details: [String: Any]?) {
    JournalProvider.shared.journal.log(message: message, level: .info, details: details ?? [:], error: nil)
}

public func verbose(message: String, details: [String: Any]?) {
